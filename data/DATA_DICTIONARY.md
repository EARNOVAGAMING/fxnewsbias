...
| `score` | integer | News-tone score 0–100. 50 = neutral; >50 leaning bullish tone, <50 leaning bearish tone |
...
- **Method (summary):** headlines from the news corpus (§1.2) are classified by
  ...
  the 0–100 score. Scores are point-in-time: they reflect the news available
...
| `strength` | integer | 1–5 conviction of the read at publication |
...
## 4. Data quality — live, machine-readable

`GET https://fxnewsbias-cron.dineshsanther123gf.workers.dev/data-quality`
...
licence — contact hello@fxnewsbias.com. Headlines remain © their publishers;
